...
## 3. Use cutadapt to demultiplex DNA/RNA reads
cutadapt --quiet -e 0.4 -g file:/home/lyuah/software/DR_sep/version2.2_mgi/dr_barcode.fasta -o trimmed-{name}.R2.fastq.gz -p trimmed-{name}.R1.fastq.gz fp_r2.fastq.gz fp_r1.fastq.gz
